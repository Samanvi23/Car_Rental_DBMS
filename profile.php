...
{ ?>
  ...
  <div class="container">
    ...
    <div class="row" >
      ...
      <div class="col-md-6 col-sm-8" style="background-color:#9CAF88;">
        <div class="profile_wrap">
          <center><h5 class="uppercase underline" style="background-color:#9CAF88;">MY PROFILE</h5></center>
          <?php
         if($msg){?><div class="succWrap"><strong>SUCCESS</strong>:<?php echo htmlentities($msg); ?> </div><?php }?>
          <form  method="post">
           <div class="form-group" style="color:white;">
              <label class="control-label" style="color:black;">REGISTRATION DATE -></label>
             <?php echo htmlentities($result->RegDate);?>
            </div>
             <?php if($result->UpdationDate!=""){?>
            <div class="form-group" style="color:white;">   
              <label class="control-label" style="color:black;">LAST UPDATED ON     -></label>
            ...
            <div class="form-group">
              <label class="control-label" style="color:black;">>  DATE OF BIRTH</label>
            ...
            <div class="form-group">
              <label class="control-label" style="color:black;">>  RESIDENTIAL ADDRESS</label>
            ...
            <div class="form-group">
              <label class="control-label" style="color:black;">>  COUNTRY</label>
            ...
            <div class="form-group">
              <label class="control-label" style="color:black;">>  CITY</label>
              <input class="form-control white_bg" id="city" name="city" placeholder="City" value="<?php echo htmlentities($result->City);?>" type="text">
            </div>
            <?php }} ?>

            <div class="form-group">
              <button type="submit" name="updateprofile" class="btn" style="background-color:black;">UPDATE MY PROFILE</button>
            </div>
          </form>
        </div>
      </div>
