...
<center><div class="page-heading">
  <br/><br/>
  <h1 style="color:black;">UPDATE PASSWORD</h1>
</div></center>
...
<form name="chngpwd" method="post" onSubmit="return valid();">
                ...
                <center><h5 class="uppercase underline" style="background-color:#9CAF88;">MY PASSWORD</h5></center>

             <?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php }
        else if($msg){?><div class="succWrap"><strong>SUCCESS</strong>:<?php echo htmlentities($msg); ?> </div><?php }?>
            <div class="form-group">
              <label class="control-label"  style="color:black;">>  CURRENT PASSWORD</label>
            ...
            <div class="form-group">
              <label class="control-label"  style="color:black;">>  CONFIRM NEW PASSWORD</label>
            ...
            <div class="form-group">
               <input type="submit" value="UPDATE" name="update" id="submit" class="btn btn-block"  style="background-color:black;">
            </div>
          </form>
        </div>
      </div>
