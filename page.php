...
$pagetype = isset($_GET['type']) ? $_GET['type'] : 'default';
$sql = "SELECT type, detail, PageName FROM tblpages WHERE type=:pagetype";
 $query = $dbh->prepare($sql);
                      ...
                      if ($query->rowCount() > 0) {
                          ...
                          echo "No data found for the given type.";
                          exit;
                      }
...
<p>&nbsp;</p>
<p>Here is what makes FastRide self-drive car rental service your first choice for renting self drive cars anywhere in India –</p>
<p>&nbsp;</p>
<u style="color:#9CAF88";>
...
<p>&nbsp;</p>
<p ><a href="car-listing.php" style="color:black;">So what are you waiting for? Time to book and ride!</a></p>
<br/><br/>
</div>
</div>
</div>
