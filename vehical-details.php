...
<section class="listing-detail" >
  <div class="container">
    <div class="listing_detail_head row">
      ...
      <div class="col-md-3" >
        <div class="price_info" style=" color:white;">
      ...
      <div class="col-md-9">
        <div class="main_features" >
          <ul>
            ...
            <li style="background-color:white;"> <i class="fa fa-calendar" aria-hidden="true" style="color:black;"></i>
              <h5 ><?php echo htmlentities($result->ModelYear);?></h5>
              <p style="color:black;">Reg.Year</p>
            </li>
            <li style="background-color:white;"> <i class="fa fa-cogs" aria-hidden="true" style="color:black;"></i>
              <h5><?php echo htmlentities($result->FuelType);?></h5>
              <p style="color:black;">Fuel Type</p>
            </li>

            <li style="background-color:white;"> <i class="fa fa-user-plus" aria-hidden="true" style="color:black;"></i>
        ...
        <div class="listing_more_info" style="color:blue;">
          <div class="listing_detail_wrap"  style="background-color:black;" >
            <!-- Nav tabs -->
            <ul class="nav nav-tabs gray-bg" role="tablist" >
              ...
              <li role="presentation" ><a href="#accessories" aria-controls="accessories" role="tab" data-toggle="tab" style="color:black;">Accessories</a></li>
            </ul>
            ...
            <div class="tab-content"style="color:blue;" >
              ...
              <div role="tabpanel" class="tab-pane" id="accessories">
                ...
                <table style="background-color:white;">
                  <thead>
                    <tr>
                      <th colspan="2" style="color:black;">Accessories</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr >
...
<?php }} ?>
      ...
      <aside class="col-md-3" >
        ...
        <div class="sidebar_widget" style="background-color:white;">
          <div class="widget_heading">
            <h5 style="color:black;">>  Book Now</h5>
          </div>
          <form method="post">
          ...
          <?php if($_SESSION['login'])
              {?>
              <div class="form-group">
                <input type="submit" class="btn"  name="submit" value="Book Now" style="background-color:black;">
              </div>
              <?php } else { ?>
<a href="#loginform" class="btn btn-xs uppercase" data-toggle="modal" data-dismiss="modal" style="background-color:black;">SIGN IN FOR BOOKING</a>
        ...
        <div class="col-md-3 grid_listing" >
          <div class="product-listing-m gray-bg" style="background-color:black;">
            ...
            <div class="product-listing-content">
              <h5 ><a href="vehical-details.php?vhid=<?php echo htmlentities($result->id);?>" style="color:white;"><?php echo htmlentities($result->BrandName);?> , <?php echo htmlentities($result->VehiclesTitle);?></a></h5>
              <p class="list-price" style="color:white;">₹<?php echo htmlentities($result->PricePerDay);?></p>

              <ul class="features_list" style="background-color:white;">

             <li style="color:black;"><i class="fa fa-user" aria-hidden="true" style="color:black;"></i><?php echo htmlentities($result->SeatingCapacity);?> seats</li>
                <li style="color:black;"><i class="fa fa-calendar" aria-hidden="true" style="color:black;"></i><?php echo htmlentities($result->ModelYear);?> model</li>
                <li style="color:black;"><i class="fa fa-car" aria-hidden="true" style="color:black;"></i><?php echo htmlentities($result->FuelType);?></li>
              </ul>
            </div>
          </div>
        </div>
